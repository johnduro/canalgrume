...
function __autoload($className)
{
    ...
    else if (file_exists(ROOT . DS . 'src' . DS . 'controllers' . DS . strtolower($className) . 'Controller.php'))
    {
        require_once(ROOT . DS . 'src' . DS . 'controllers' . DS . strtolower($className) . 'Controller.php');
    }
    else
    {
        //throw error here
